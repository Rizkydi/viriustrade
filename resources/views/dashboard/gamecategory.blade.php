                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="../assets/images/users/admin.png" alt="user" class="profile-pic me-2"> Admin
                            </a>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex">
                                    <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Account in database</h4>
                                                    ...
                                                    <div class="action-flex">
                                                        ...
                                                        <td><div class="form-group">
                                                            <div class="col-sm-12 d-flex">
                                                                <a href=""><button class="btn btn-success mx-auto mx-md-2 text-white">Edit</button></a>
